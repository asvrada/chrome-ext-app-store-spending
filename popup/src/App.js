        ...
        <MessengerContext.Provider value={messenger}>
            <div className="App text-base text-center font-sans pb-4">
                ...
                <div className="flex justify-center items-center m-4">
                    <div className="mr-4">
                        <img className="w-20" src="./3rdparty/App_Store.png" alt="App Store Logo"/>
                    </div>
                ...
                <div className="m-4 p-2 flex justify-around items-center border-2 rounded-lg border-black">
                    ...
                    <div className="flex-auto">
                        <div><strong><span>&#8505;&#160;</span>{t("heading_step1")}</strong></div>
                        <div>{t("please")}<a
                            ...
                            target="_blank"
                            rel="noreferrer">{t("link_apple")}</a>{t("and")}<strong>{t("login")}</strong></div>
                    </div>
                </div>
